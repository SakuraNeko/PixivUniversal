...
namespace Pixeez
{
    ...
    static public class AuthConsts
    {
        ...
        public static Tuple<string, string> AppVersion => new Tuple<string, string>("App-Version", "6.4.0");
        public static Tuple<string, string> UserAgent => new Tuple<string, string>("User-Agent", "PixivIOSApp/6.0.9 (iOS 10.2.1; iPhone8,1)");
        public static Tuple<string, string> GetSecureUrl => new Tuple<string, string>("get_secure_url", "1");
        public static Tuple<string, string> ClientId => new Tuple<string, string>("client_id", "bYGKuGVw91e0NMfPGp44euvGt59s");
        public static Tuple<string, string> ClientSecret => new Tuple<string, string>("client_secret", "HP3RmkgAmEGro0gn1x9ioawQE8WMfvLXDz3ZqxpK");
